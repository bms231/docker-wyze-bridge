...
[![GitHub release (latest by date)](https://img.shields.io/github/v/release/lukeb212/docker-wyze-bridge?logo=github)](https://github.com/lukeb212/docker-wyze-bridge/releases/latest)
[![Docker Image Size (latest semver)](https://img.shields.io/docker/image-size/lukeb212/wyze-bridge?sort=semver&logo=docker&logoColor=white)](https://hub.docker.com/r/lukeb212/wyze-bridge)
[![Docker Pulls](https://img.shields.io/docker/pulls/lukeb212/wyze-bridge?logo=docker&logoColor=white)](https://hub.docker.com/r/lukeb212/wyze-bridge)
...
```bash
docker run -p 8554:8554 -p 8888:8888 -p 5050:5000 -e WB_AUTH=false lukeb212/wyze-bridge
```
...
[View previous changes](https://github.com/lukeb212/docker-wyze-bridge/releases)
...
[![Home Assistant Add-on](https://img.shields.io/badge/home_assistant-add--on-blue.svg?logo=homeassistant&logoColor=white)](https://github.com/lukeb212/docker-wyze-bridge/wiki/Home-Assistant)
...
> [!IMPORTANT]
> Some newer camera firmware versions may cause issues with remote access via P2P. Local "LAN" access seems unaffected at this time. A temporary solution is to use a VPN. See the [OpenVPN example](https://github.com/lukeb212/docker-wyze-bridge/blob/main/docker-compose.ovpn.yml).
...
2. Use the [sample](https://raw.githubusercontent.com/lukeb212/docker-wyze-bridge/main/docker-compose.sample.yml) as a guide to create a `docker-compose.yml` file with your wyze credentials.
...
[![Open your Home Assistant instance and show the add add-on repository dialog with a specific repository URL pre-filled.](https://my.home-assistant.io/badges/supervisor_add_addon_repository.svg)](https://my.home-assistant.io/redirect/supervisor_add_addon_repository/?repository_url=https%3A%2F%2Fgithub.com%lukeb212%2Fdocker-wyze-bridge)
